 ...
 * @author Matt DeVore
 */
public class ListViewElement<V extends ListView> extends ViewElement<V> {
  /**
  ...
  public static final ViewElementType TYPE
      ...
      public ViewElement<?> newInstance(ElementContext context, View view) {
        return new ListViewElement<ListView>(context, (ListView)view);
      }
  };
  ...
  public ListViewElement(ElementContext context, V view) {
    super(context, view);
  }
