...
/**
 * Handler for {@link WebElement#findElement(By)}. Identical to the default
 * WebDriver handler, but uses a different {@code BySelector} implementation.
 *
 * @author Matt DeVore
 */
public class AndroidNativeFindChildElement extends WebElementHandler
  ...
  public String toString() {
    return String.format(
        "[find child element: %s, %s]", getElementAsString(), by);
  }
}
