 ...
 * @author Matt DeVore
 */
public class TabHostElement<V extends TabHost> extends ViewElement<V> {
  /**
  ...
  public static final ViewElementType TYPE
      ...
      public ViewElement<?> newInstance(ElementContext context, View view) {
        return new TabHostElement<TabHost>(context, (TabHost)view);
      }
  };
  ...
  public TabHostElement(ElementContext context, V view) {
    super(context, view);
  }
